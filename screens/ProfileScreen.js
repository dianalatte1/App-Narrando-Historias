      ...
      <View style={theme ? styles.containerLight : styles.container}>
        ...
        <View style={styles.screenContainer}>
          <View style={styles.profileImageContainer}>
            ...
            ></Image>
            {/* cambiamos esto */}
            <Text style={theme ? styles.nameTextLight : styles.nameText}>
              {name}
            </Text>
          </View>
          <View style={styles.themeContainer}>
            {/* cambiamos esto */}
            <Text style={theme ? styles.themeTextLight : styles.themeText}>
              Tema oscuro
            </Text>
            <Switch
              style={{
              ...
              trackColor={{ false: "#767577", true: theme ? "#eee" : "white" }}
